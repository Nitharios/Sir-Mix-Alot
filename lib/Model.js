...
function Model(schema) {
  ...
  // store[this.constructor.name].counter = 1;
}
...
Model.getNextId = function() {
  ...
  // }
  // return this.counter++;
  // return store[this.name].counter++;
  // if (!this.getNextId.prototype.counter) this.getNextId.prototype.counter = 0; 
  // return this.getNextId.prototype.counter += 1;
